...
public class PushNotificationEngine implements NotificationEngine {
  ...
  public class PushManagerRejectedNotificationListener
    ...
    public void handleRejectedNotification(SimpleApnsPushNotification notification,
  ...
  private PushNotificationEngine() {
    ...
    try {
      ...
      ApnsEnvironment env =
          isprod ? ApnsEnvironment.getProductionEnvironment() : ApnsEnvironment
              .getSandboxEnvironment();

      _pushManager =
          new PushManager<SimpleApnsPushNotification>(env, keyStore, password.toCharArray());
      _pushManager
          .registerRejectedNotificationListener(new PushManagerRejectedNotificationListener());
    } catch (Exception e) {
