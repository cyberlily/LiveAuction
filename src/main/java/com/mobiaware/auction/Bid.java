...
public class Bid {
  ...
  public boolean equals(final Object obj) {
    ...
    return Objects.equal(getUid(), other.getUid()) && Objects.equal(getItemUid(), other.getItemUid())
        && Objects.equal(getUserUid(), other.getUserUid()) && Objects.equal(getBidPrice(), other.getBidPrice())
  ...
  public String toString() {
    return Objects.toStringHelper(getClass()).add("uid", getUid()).add("itemuid", getItemUid())
        .add("useruid", getUserUid()).add("bidprice", getBidPrice()).add("biddate", getBidDate()).toString();
  }
}
