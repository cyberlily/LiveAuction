...
public class Auction {
  ...
  public boolean equals(final Object obj) {
    ...
    return Objects.equal(getUid(), other.getUid()) && Objects.equal(getName(), other.getName())
        && Objects.equal(getStartDate(), other.getStartDate()) && Objects.equal(getEndDate(), other.getEndDate());
  }

  @Override
  public String toString() {
    return Objects.toStringHelper(getClass()).add("uid", getUid()).add("name", getName()).add("active", isActive())
        .toString();
  }
}
