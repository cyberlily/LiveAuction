...
public class Category {
  ...
  @JsonCreator
  public Category(@JsonProperty("uid") final int uid, @JsonProperty("auctionUid") final int auctionUid,
  ...
  public String toString() {
    return Objects.toStringHelper(getClass()).add("uid", getUid()).add("name", getName()).toString();
  }
}
