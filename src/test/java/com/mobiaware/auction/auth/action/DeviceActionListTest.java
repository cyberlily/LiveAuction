...
public class DeviceActionListTest {
  @Test
  public void testShouldSucceed() throws JsonMappingException, JsonParseException, IOException {
    ...
    when(data.getDeviceCount()).thenReturn(1);
    when(data.getDevices(0, 5, null, null)).thenReturn(ImmutableList.of(DeviceSerializationTest.DEVICE));
