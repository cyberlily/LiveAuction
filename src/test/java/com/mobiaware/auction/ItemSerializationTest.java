...
public class ItemSerializationTest {
  ...
  public static final Item ITEM = Item.newBuilder().uid(1).auctionUid(1).itemNumber("100").name("Fred's Bowling Ball")
      .description("The official ball used by Fred Flinstone.").category("Sports").seller("Wilma Flinstone")
      .valPrice(1000.00).minPrice(500.00).incPrice(10.00).curPrice(900.00).winner("Barney Rubble").bidCount(5)
      .watchCount(100).url("http://www.flinstone.com/ball.png").multi(false).build();
