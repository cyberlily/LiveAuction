...
public class WatchSerializationTest {
  public static final String FIXTURE = "watch.json";

  public static final Watch WATCH = Watch.newBuilder().uid(1).itemUid(1).userUid(1).build();

  @Test
  public void testSerializeToJson() throws IOException {
    Assert.assertEquals(fixture(FIXTURE), toJson(WATCH, false));
  }

  @Test
  public void testLoadFromJson() throws IOException {
    Assert.assertEquals(WATCH, fromJson(fixture(FIXTURE), Watch.class));
  }
}
