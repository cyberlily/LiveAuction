...
public class AuctionActionListCountTest {
  @Test
  public void testShouldSucceed() throws IOException {
    ...
    Mockito.when(data.getAuctionCount()).thenReturn(100);

    AuctionActionListCount action = Mockito.spy(new AuctionActionListCount());
