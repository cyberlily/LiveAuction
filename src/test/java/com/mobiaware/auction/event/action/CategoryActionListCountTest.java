...
public class CategoryActionListCountTest {
  @Test
  public void testShouldSucceed() throws IOException {
    ...
    Mockito.when(data.getCategoryCount(1)).thenReturn(100);

    CategoryActionListCount action = Mockito.spy(new CategoryActionListCount());
